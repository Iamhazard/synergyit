...
import Section from "@/components/ui/mission/Section";
import Header from "@/components/ui/mission/Header";
import { roadmap } from "@/data";
import TagLine from "@/components/ui/mission/Tagline";
...
const Roadmap = () => (
  <Section className="overflow-hidden" id="roadmap">
    <div className="container md:pb-10">
      <Header tag="Ready to get started" title="What we’re working on" />
