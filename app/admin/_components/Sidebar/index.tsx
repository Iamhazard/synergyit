          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/admin/dashboard/comapany"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-fuchsia-700 ${pathname === "/" && "text-white"
                                }`}
                            >
                              Company
                            </Link>
              ...
              <li>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-person-standing"><circle cx="12" cy="5" r="1" /><path d="m9 20 3-6 3 6" /><path d="m6 8 6 2 6-2" /><path d="M12 10v4" /></svg>
                  Clients
                </Link>
              </li>    <li>
                <Link
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-rail-symbol"><path d="M5 15h14" /><path d="M5 9h14" /><path d="m14 20-5-5 6-6-5-5" /></svg>
                  RoadMap
                </Link>
              </li>
              {/* <!-- Menu Item Tables --> */}
